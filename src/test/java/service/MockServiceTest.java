...
public class MockServiceTest {
    ...
    @Test
    public void shouldReturnVayneWhenAnyChampionGetName(){
        Champion champion = mock(Champion.class);
    ...
    public void sholdDothrowExceptionWhenChampionSetNameYasuo(){
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void sholdPassWhenNeverRunChampionSetName(){
        Champion champion = mock(Champion.class);
        champion.setName("조이");
        champion.setPosition("미드");
        champion.setHasSkinCount(3);
